...
public class BlendJobTicket extends BaseTest{

	@Test(dataProvider = "getData")
	public void completeBlendJob(HashMap<String, String> data) throws Exception {
		if (!data.get("RunMode").equalsIgnoreCase("N") && isTestSkipped(data.get("TestName"))) {
			...
			jobs
				...
				.gotoCondition()
				.startJobDataUpdate(data)
				.fieldConditionUpdate(data)
				.vehicleUpdation(data)
				.regulationUpdation(data)
				.endOfJob(data)
				.gotoOverview();
			jobs.startOrComplete()
				.finaliseConditions()
				.drawSign();
		} else {
